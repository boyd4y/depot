...
class FactoriesControllerTest < ActionController::TestCase
  ...
  test "should create factory" do
    assert_difference('Factory.count') do
      post :create, factory: { code: @factory.code, description: @factory.description, email: @factory.email, name: @factory.name }
    end
  ...
  test "should update factory" do
    put :update, id: @factory, factory: { code: @factory.code, description: @factory.description, email: @factory.email, name: @factory.name }
    assert_redirected_to factory_path(assigns(:factory))
  end
